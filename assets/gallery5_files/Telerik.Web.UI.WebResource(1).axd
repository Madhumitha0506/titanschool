...
return false;
}var t=this._isUsedOnTouchDevices?s.target:s.eventMapTarget,r=this._extractItemFromDomElement(t),u=this._getFirstClickableParent(s.target,r.get_element());
if(this._isUsedOnTouchDevices){s.preventDefault();
}if(u&&!p(u).hasClass(d)){return false;
}if(p(s.eventMapTarget).is(".rmItem")&&r.get_linkElement()){return false;
}r._transferFocus();
r._click(s);
if(!r._shouldNavigate()){$telerik.cancelRawEvent(s);
}return false;
...
(function() {
    function loadHandler() {
        ...
        hf.value += ';;System.Web.Extensions, Version=4.0.0.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35:en:c9cbdec3-c810-4e87-846c-fb25a7c08002:ea597d4b:b25378d2;Telerik.Web.UI, Version=2012.3.1205.40, Culture=neutral, PublicKeyToken=121fae78165ba3d4:en:0dab3778-a2be-47a7-bc5b-fee31555d0d2:16e4e7cd:f7645509:24ee1bba:e330518b:2003d0b8:1e771326:c8618e41';                                    
